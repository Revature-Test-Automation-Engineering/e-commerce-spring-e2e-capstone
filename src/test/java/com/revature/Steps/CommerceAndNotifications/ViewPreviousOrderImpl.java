...
public class ViewPreviousOrderImpl {
    ...
    public WebDriver driver = CommerceAndNotificationsRunner.driver;
    public MainPage mainPage = CommerceAndNotificationsRunner.mainPage;
    public LoginPage loginPage = CommerceAndNotificationsRunner.loginPage;
    public OrdersPage ordersPage = CommerceAndNotificationsRunner.ordersPage;
