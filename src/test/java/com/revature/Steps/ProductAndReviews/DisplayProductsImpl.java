...
public class DisplayProductsImpl {
    ...
    @Given("the user logs in with the email {string} and the password {string}")
    public void the_user_logs_in_with_the_email_and_the_password(String string, String string2) {
