...
public class ManageProfileImpl {
    ...
    public void user_types_in_the_first_name_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("User types {string} in the Last Name field")
    public void user_types_in_the_last_name_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("User types {string} in the Password field")
    public void user_types_in_the_password_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void user_types_in_the_card_number_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("User types {string} in the Expiry Date field")
    public void user_types_in_the_expiry_date_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("User types {string} in the CCV field")
    public void user_types_in_the_ccv_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void user_should_get_a_success_message_and_new_card_details_should_appear_on_the_page() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("User should not get a success message and new card details should not appear on the page")
    public void user_should_not_get_a_success_message_and_new_card_details_should_not_appear_on_the_page() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void the_user_should_get_a_success_message_and_the_card_should_be_removed() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
